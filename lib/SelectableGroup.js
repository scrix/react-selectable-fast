...
var SelectableGroup = (function (_super) {
    ...
    function SelectableGroup() {
        ...
        _this.updateSelecting = function () {
            ...
            _this.selectItems(__assign(__assign({}, selectboxBounds[0]), { offsetWidth: selectboxBounds[0].offsetWidth || 1, offsetHeight: selectboxBounds[0].offsetHeight || 1 }));
        };
    ...
    SelectableGroup.prototype.processItem = function (options) {
        ...
        var isCollided = item.bounds.some(function (bound) { return utils_1.doObjectsCollide(selectboxBounds, bound, tolerance, _this.props.delta); });
