...
var SelectableGroup = (function(_super) {
  ...
  function SelectableGroup() {
    ...
    _this.unregisterSelectable = function(selectableItem) {
      ...
      var isHandled =
        _this.selectedItems.has(selectableItem) || _this.selectingItems.has(selectableItem)
    ...
    _this.getScrollStep = function(offset) {
      var _a = _this.props,
        minimumSpeedFactor = _a.minimumSpeedFactor,
        scrollSpeed = _a.scrollSpeed
    ...
    _this.updateSelecting = function() {
      ...
      _this.selectItems(
        __assign(__assign({}, selectboxBounds[0]), {
    ...
    _this.selectItems = function(selectboxBounds, options) {
      ...
      var _b = _this.props,
        tolerance = _b.tolerance,
        enableDeselect = _b.enableDeselect,
        mixedDeselect = _b.mixedDeselect
    ...
    _this.clearSelection = function() {
      ...
      try {
        for (
          var _b = __values(_this.selectedItems.values()), _c = _b.next();
          !_c.done;
          _c = _b.next()
        ) {
          var item = _c.value
    ...
    _this.mouseUp = function(event) {
      ...
      if (!_this.mouseMoved && utils_1.isNodeInRoot(evt.target, _this.selectableGroup)) {
        ...
        try {
          for (
            var _b = __values(_this.selectingItems.values()), _c = _b.next();
            !_c.done;
            _c = _b.next()
          ) {
            var item = _c.value
  ...
  SelectableGroup.prototype.toggleSelectionMode = function() {
    var _a = this,
      ...
      selectionMode = _a.state.selectionMode
  ...
  SelectableGroup.prototype.processItem = function(options) {
    var item = options.item,
      ...
      selectboxBounds = options.selectboxBounds,
      enableDeselect = options.enableDeselect,
      mixedDeselect = options.mixedDeselect,
      isFromClick = options.isFromClick
    if (this.isInIgnoreList(item.node)) {
      return null
    }
    var isCollided = false
    for (var i = 0; i < item.bounds.length; i += 1) {
      isCollided = utils_1.doObjectsCollide(
        selectboxBounds,
        item.bounds[i],
        tolerance,
        this.props.delta
  ...
  SelectableGroup.prototype.handleClick = function(evt, top, left) {
    ...
    var _a = this.props,
      clickClassName = _a.clickClassName,
      allowClickWithoutSelected = _a.allowClickWithoutSelected,
      onSelectionFinish = _a.onSelectionFinish
  ...
  SelectableGroup.prototype.render = function() {
    ...
    var _a = this.props,
      _b = _a.component,
      GroupComponent = _b === void 0 ? 'div' : _b,
      className = _a.className,
      style = _a.style,
      selectionModeClass = _a.selectionModeClass,
      fixedPosition = _a.fixedPosition,
      selectboxClassName = _a.selectboxClassName,
